...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__a = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 7463498433374465778ull);
    vlSelf->sim_top__DOT__tb__DOT__b = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 6517051422318198634ull);
    vlSelf->sim_top__DOT__tb__DOT__i = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 16675629135622708989ull);
    vlSelf->sim_top__DOT__tb__DOT__j = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 10267032307588213958ull);
    vlSelf->sim_top__DOT__tb__DOT__nfail = VL_SCOPED_RAND_RESET_I(32, __VscopeHash, 3770900744349794232ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__result = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 11122441516821775573ull);
