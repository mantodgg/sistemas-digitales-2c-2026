...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgBit(oldp+3,((0U == (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__current_state))));
        bufp->chgCData(oldp+4,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__posicion),2);
        bufp->chgCData(oldp+5,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__current_state),2);
    }
    bufp->chgBit(oldp+6,(vlSelfRef.sim_top__DOT__clk));
    bufp->chgBit(oldp+7,(vlSelfRef.sim_top__DOT__rst));
    bufp->chgBit(oldp+8,(vlSelfRef.sim_top__DOT__done));
    bufp->chgBit(oldp+9,(vlSelfRef.sim_top__DOT__pass_all));
