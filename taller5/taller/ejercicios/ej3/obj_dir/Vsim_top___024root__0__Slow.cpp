...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__posicion = VL_SCOPED_RAND_RESET_I(2, __VscopeHash, 12487566659708048144ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__controlador__DOT__current_state = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 9537637209420585906ull);
