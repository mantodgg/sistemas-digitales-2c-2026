...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__r_a = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 6376838426604971509ull);
    vlSelf->sim_top__DOT__tb__DOT__r_b = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 14476504314195047299ull);
    vlSelf->sim_top__DOT__tb__DOT__r_s = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 7621342862074506644ull);
    vlSelf->sim_top__DOT__tb__DOT__cout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 8693409108266565656ull);
