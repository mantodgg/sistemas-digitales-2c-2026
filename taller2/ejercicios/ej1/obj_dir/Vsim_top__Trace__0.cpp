...
void Vsim_top___024root__trace_chg_0_sub_0(Vsim_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+2,(vlSelfRef.sim_top__DOT__tb__DOT__d));
        bufp->chgBit(oldp+3,(vlSelfRef.sim_top__DOT__tb__DOT__rst_extra));
        bufp->chgIData(oldp+4,(vlSelfRef.sim_top__DOT__tb__DOT__nfail),32);
        bufp->chgIData(oldp+5,(vlSelfRef.sim_top__DOT__tb__DOT__npass),32);
    }
    bufp->chgBit(oldp+6,(vlSelfRef.sim_top__DOT__clk));
    bufp->chgBit(oldp+7,(vlSelfRef.sim_top__DOT__rst));
    bufp->chgBit(oldp+8,(vlSelfRef.sim_top__DOT__tb__DOT__q));
    bufp->chgBit(oldp+9,(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__rst));
}
