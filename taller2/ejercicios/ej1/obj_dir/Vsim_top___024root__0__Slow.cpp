...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 5336497946511896425ull);
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3024933774186773652ull);
