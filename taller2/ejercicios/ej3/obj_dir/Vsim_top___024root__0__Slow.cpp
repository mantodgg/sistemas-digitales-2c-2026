...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__we = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4873853522417292418ull);
    vlSelf->sim_top__DOT__tb__DOT__din = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 13523411168175142947ull);
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__registro0__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__registro1__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__registro2__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT____Vcellout__registro3__q = 0;
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__registro3__DOT__ff_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6370621318886628019ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__registro2__DOT__ff_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16875046045293450073ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__registro1__DOT__ff_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12038561901673572050ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__registro0__DOT__ff_d__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17770763733424131620ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__registro0__DOT__ff_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9545089284082328975ull);
