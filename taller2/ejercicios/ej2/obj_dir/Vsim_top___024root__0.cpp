...
VlCoroutine Vsim_top___024root___eval_initial__TOP__Vtiming__1(Vsim_top___024root* vlSelf) {
    ...
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__1__got 
        = vlSelfRef.sim_top__DOT__tb__DOT__q;
    ...
    vlSelfRef.sim_top__DOT__tb__DOT__din = 1U;
    Vsim_top___024root____VbeforeTrig_hffd278f5__0(vlSelf, 
                                                   "@(posedge sim_top.clk)");
    co_await vlSelfRef.__VtrigSched_hffd278f5__0.trigger(0U, 
                                                         nullptr, 
    ...
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__3__got 
        = vlSelfRef.sim_top__DOT__tb__DOT__q;
    vlSelfRef.__Vtask_sim_top__DOT__tb__DOT__expect_eq__3__tag = "we=1 carga 1"s;
    ...
    co_await vlSelfRef.__VtrigSched_hffd279b4__0.trigger(0U, 
                                                         ...
                                                         45);
    vlSelfRef.__Vm_traceActivity[2U] = 1U;
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__5__exp = 1U;
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__5__got 
        = vlSelfRef.sim_top__DOT__tb__DOT__q;
    vlSelfRef.__Vtask_sim_top__DOT__tb__DOT__expect_eq__5__tag = "we=0 conserva 1"s;
    ...
    co_await vlSelfRef.__VtrigSched_hffd279b4__0.trigger(0U, 
                                                         ...
                                                         45);
    vlSelfRef.__Vm_traceActivity[2U] = 1U;
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__7__exp = 0U;
    __Vtask_sim_top__DOT__tb__DOT__expect_eq__7__got 
        = vlSelfRef.sim_top__DOT__tb__DOT__q;
    vlSelfRef.__Vtask_sim_top__DOT__tb__DOT__expect_eq__7__tag = "we=1 carga 0"s;
            ...
            if ((0x000000000000000fULL & vlSelfRef.__VactTriggered[0U])) {
                {
                    ...
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__rst 
            ...
            if ((0x000000000000000dULL & vlSelfRef.__VactTriggered[0U])) {
                {
                    ...
                    vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__d 
                        = ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__we)
            ...
            if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    CData/*0:0*/ __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__q;
                    __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__q = 0;
                    CData/*0:0*/ __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q;
                    __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q = 0;
                    if (vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__rst) {
                        vlSelfRef.sim_top__DOT__tb__DOT__q = 0U;
                    }
                    if ((1U & (~ (IData)(vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__rst)))) {
                        __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__q 
                            = vlSelfRef.sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__d;
                        __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q = 1U;
                    }
                    vlSelfRef.sim_top__DOT__tb__DOT__q 
                        = ((__Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__q 
                            & __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q) 
                           | ((IData)(vlSelfRef.sim_top__DOT__tb__DOT__q) 
                              & (~ (IData)(__Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q))));
                    __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___VdlyMask__sim_top__DOT__tb__DOT__q = 0U;
                }
            }
