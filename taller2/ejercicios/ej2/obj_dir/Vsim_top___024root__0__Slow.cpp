...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__din = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13523411168175142947ull);
    vlSelf->sim_top__DOT__tb__DOT__q = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1136067102388444698ull);
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__rst = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15945696136321141103ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__ff_d__DOT__d = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 9652707513653232733ull);
