            ...
            if ((1ULL & vlSelfRef.__VnbaTriggered[0U])) {
                {
                    ...
                    CData/*1:0*/ __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__value;
                    ...
                    if (vlSelfRef.sim_top__DOT__rst) {
                        __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__value = 3U;
                        ...
                        __Vinline_0__eval_nba___Vinline_0__nba_sequent__TOP__0___Vdly__sim_top__DOT__tb__DOT__value 
                            = (3U & ((IData)(1U) + (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value)));
                                              ...
                                              (~ ((
                                                   ...
                                                   (1U 
                                                    & (vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0 
                                                       >> 1U))) 
                                                  & ((1U 
                                                      & VL_REDXOR_2(vlSelfRef.sim_top__DOT__tb__DOT__value)) 
                                                     == 
                                                     (1U 
                                                      & vlSelfRef.__VdfgRegularize_h6e95ff9d_0_0)))))))) {
                                VL_WRITEF_NX("\033[31mFAIL: value = %0d (%b)\033[0m\n",2
                                             , '#',2,vlSelfRef.sim_top__DOT__tb__DOT__value
                                             , '#',2,(IData)(vlSelfRef.sim_top__DOT__tb__DOT__value));
                                vlSelfRef.sim_top__DOT__tb__DOT__oracle__DOT__tests_passing = 0U;
                            }
                            if ((3U == (IData)(vlSelfRef.sim_top__DOT__tb__DOT__value))) {
