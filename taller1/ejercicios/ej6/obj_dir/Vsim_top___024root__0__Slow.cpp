...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__tmp = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 7422197743330558141ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__b1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12162107577331707577ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__b2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4298598695382856160ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__b3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 6563401375521695370ull);
