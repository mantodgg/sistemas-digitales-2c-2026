...
VL_ATTR_COLD void Vsim_top___024root___ctor_var_reset(Vsim_top___024root* vlSelf) {
    ...
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__c1 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12882737581263536834ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__c2 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7173986424043025776ull);
    vlSelf->sim_top__DOT__tb__DOT__dut__DOT__c3 = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 7908233713019882909ull);
